...
class Rotas {
    ...
    constructor(){
       this.rotas = [
            {regex : /^\/Home$/i, page: "home"}, 
            {regex : /^\/Login$/i, page: "login"}, 
            {regex : /^\/Cadastre-se$/i, page: "cadastro"},
            {regex : /^\/Post\/([\p{L}\p{N}_-]+)$/iu, page: "post"},
            {regex :/^\/Generos\/([\p{L}\p{N}_-]+)$/iu, page: "generos"},
        ]
    }
